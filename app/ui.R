...
shinyUI(fluidPage(
  ...
  sidebarPanel(
    ...
    conditionalPanel(condition="[1, 2, 3, 4, 6, 7].indexOf(parseInt(input.conditionedPanels)) > -1",
                     ...
                     radioButtons(inputId = "inGEQ", label = "Select Equity in Age and Gender uptake (EQ):", onOffRButton, inline = TRUE),
    ...
    conditionalPanel(condition="input.conditionedPanels == 5",
                     ...
                     radioButtons(inputId = "inHealthEQ", label = "Select Equity in Age and Gender uptake (EQ):", onOffRButton, inline = TRUE),
                     ...
                     conditionalPanel(
                       ...
                       radioButtons(inputId = "inHealthEQ1", label = "Select Equity in Age and Gender uptake (EQ):", onOffRButton, inline = TRUE),
    ...
    conditionalPanel(condition="input.conditionedPanels == 8",
                     radioButtons(inputId = "inEQ", label = "Select Equity in Age and Gender uptake (EQ):", allOnOffRButton, inline = TRUE),
